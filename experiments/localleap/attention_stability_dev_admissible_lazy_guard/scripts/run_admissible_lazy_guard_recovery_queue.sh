...
quick_queue=${QUICK_QUEUE:-/root/autodl-tmp/LocalLeap/llada_slot_admissible_lazy_guard/results/experiment_queues/admissible_lazy_guard_20260719_v1}
quick_runs=${QUICK_RUNS:-/root/autodl-tmp/LocalLeap/llada_slot_admissible_lazy_guard/results/best_symmetric_benchmarks/admissible_lazy_guard_20260719_v1}
...
queue_id=${ATTENTION_QUEUE_ID:-admissible_lazy_guard_recovery_v2_20260719}
...
controller=${source_root}/scripts/run_admissible_lazy_guard_recovery_queue.sh
...
he_dev=${quick_runs}/humaneval/he_admissible_dev32
gsm_run=${quick_runs}/gsm8k/gsm_admissible_n64
wait_for_file "${he_dev}/DONE"
wait_for_file "${gsm_run}/DONE"
