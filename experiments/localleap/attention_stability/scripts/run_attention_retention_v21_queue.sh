...
queue_id=${ATTENTION_QUEUE_ID:-attention_retention_v21_20260716}
...
echo "new_temporal_rule=parent_preserving_topk_overlap_k4"
...
run_stage smoke_he_retention_v21 "${runner}" humaneval 0 256 symmetric_retention 0.004 full retention_v21_smoke_he 1
run_stage smoke_gsm8k_auditor_v21 "${runner}" gsm8k 5 128 baseline 0.004 trace retention_v21_smoke_gsm8k 1

# HumanEval: compare the new vertical rule with the registered original-LLaDA and best-parent runs.
run_stage he_retention_v21_256 "${runner}" humaneval 0 256 symmetric_retention 0.004 full retention_v21_he_256
run_stage he_retention_v21_fast_128 "${runner}" humaneval 0 128 symmetric_retention_fast 0.004 full retention_v21_he_fast_128
...
run_stage mbpp_retention_v21_128 "${runner}" mbpp 3 128 symmetric_retention 0.004 full retention_v21_mbpp_128
run_stage mbpp_retention_v21_fast_128 "${runner}" mbpp 3 128 symmetric_retention_fast 0.004 full retention_v21_mbpp_fast_128

# GSM8K is an untouched cross-domain generalization check with aligned prompts/shots/seeds.
run_stage gsm8k_original_llada_128 "${runner}" gsm8k 5 128 baseline 0.004 trace retention_v21_gsm8k_baseline_128
run_stage gsm8k_parent_symmetric_128 "${runner}" gsm8k 5 128 symmetric 0.004 trace retention_v21_gsm8k_parent_128
run_stage gsm8k_retention_v21_128 "${runner}" gsm8k 5 128 symmetric_retention 0.004 trace retention_v21_gsm8k_128
run_stage gsm8k_retention_v21_fast_128 "${runner}" gsm8k 5 128 symmetric_retention_fast 0.004 trace retention_v21_gsm8k_fast_128
